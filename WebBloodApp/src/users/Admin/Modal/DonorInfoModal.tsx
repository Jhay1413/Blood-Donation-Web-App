                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className='grid grid-cols-4 gap-4'>
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <Field type="text" name="bloodType" className="p-2 border-2 rounded-lg" placeholder="Donor Address" />
                                            <ErrorMessage name="bloodType" component="div" className="text-red-500" />
                                        </div>
                                        <div className="flex flex-col">
                                            <label>Date of Birth</label>
                                            <Field type="text" name="DOB" className="p-2 border-2 rounded-lg" placeholder="Donor Address" />
